...
//|                                             https://www.mql5.com |
//|==================================================================|
//|              after sell or buy based on moving averages          |
//|               the stop loss will folow the price                 |
//|------------------------------------------------------------------|
//|------------- ma15 crors up   ma240 =>   buy ---------------------|
//|------------- ma15 crors down ma240 => sell  ---------------------|
//|------------- ma15 crors down ma240 => sell  ---------------------|
//|------------------------------------------------------------------|
...
class MaTrailing:public Strategy{
   private:
      CTrade trade;
