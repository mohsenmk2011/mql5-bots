...
//|                                                                  |
//+------------------------------------------------------------------+
class BBandsMidLineTfComplex02 : public Strategy
{
private:
   bool              buyLock;
   bool              sellLock;
...
//|                                                                  |
//+------------------------------------------------------------------+
BBandsMidLineTfComplex02::BBandsMidLineTfComplex02()
{
   buyLock=false;
   sellLock=false;
   canBuy=false;
...
//|                          Run                                     |
//+------------------------------------------------------------------+
void BBandsMidLineTfComplex02::Run()
{
   this.comment="";
...
//|                  Is MidLine Straight                             |
//+------------------------------------------------------------------+
bool BBandsMidLineTfComplex02::IsMidLineStraight(double angle)
{
...
//+------------------------------------------------------------------+
bool BBandsMidLineTfComplex02::IsMidLineGoingDown(double angle)
{
   return angle<=27;
}
//+------------------------------------------------------------------+
//|                   Is MidLine going up                            |
//+------------------------------------------------------------------+
bool BBandsMidLineTfComplex02::IsMidLineGoingUp(double angle)
{
   return angle>=27;
}
//+------------------------------------------------------------------+
...
//+------------------------------------------------------------------+
bool BBandsMidLineTfComplex02::IsPriceTouchedTop(MqlRates& H1Prices[],double& line[])
{
...
//+------------------------------------------------------------------+
bool BBandsMidLineTfComplex02::IsPriceTouchedDown(MqlRates& H1Prices[],double& line[])
{
   return H1Prices[2].close<=line[2]&&H1Prices[1].close>=line[1];
}
//+------------------------------------------------------------------+
//|                  Is Price Passed Up                              |
//+------------------------------------------------------------------+
bool BBandsMidLineTfComplex02::IsPricePassedUp(MqlRates& H1Prices[],double& line[])
{
   return H1Prices[2].close<=line[2]&&H1Prices[1].close>=line[1];
}
//+------------------------------------------------------------------+
...
//+------------------------------------------------------------------+
bool BBandsMidLineTfComplex02::IsPricePassedDown(MqlRates& H1Prices[],double& line[])
{
   return H1Prices[2].close>=line[2]&&H1Prices[1].close<=line[1];
}
//+------------------------------------------------------------------+
